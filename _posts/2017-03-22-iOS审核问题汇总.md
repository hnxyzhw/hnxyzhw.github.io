...
layout: post
title: iOS审核问题汇总
date: 2017-03-22 15:50:0.000000000 +09:00
tags: iOS,AppleStore
---
...
[Github地址：iOS审核问题汇总](https://github.com/hnxyzhw/AppStoreReviewsAndRejected)
...
##### <span id="PLA-1.2">1: PLA-1.2审核案例</span> 
...
#### <span id="Safety-1.2">2: Safety-1.2审核案例</span> 
...
#### <span id="Performance-2.1">3: Performance-2.1审核案例</span> 
...
#### <span id="Performance-2.3.1">5: Performance-2.3.1审核案例</span> 
...
#### <span id="2.3.10">6: 2.3.10审核案例</span> 
...
#### <span id="PLA-3.3.12">7: PLA-3.3.12审核案例</span> 
...
#### <span id="PLA-3.3.2">8: PLA-3.3.2热更新审核案例</span> 
...
#### <span id="Legal-5.2.3">9: Legal-5.2.3审核案例</span> 
...
#### <span id="Legal-5.3.3">10: Legal-5.3.3审核案例</span> 
